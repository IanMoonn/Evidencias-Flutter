        ...
        bottomNavigationBar: BottomAppBar(
          ...
          child: Row(
            ...
            children: [
              ...
              IconButton(icon: const Icon(Icons.square_outlined ), onPressed: () {},),
            ],
          ),
        ),
  ...
  Widget _buildList(){
    return ListView(
      children: [
        ...
        _tile("United Artists Stonetown Twin", "501 buckingham Way", Icons.theaters),
        _tile("AMC Metreon 16", "135 4th St #3000", Icons.theaters),
        const Divider(),
        _tile("K/'s Kitchen", "757 Montery Blvd", Icons.restaurant),
